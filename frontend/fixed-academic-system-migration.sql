-- ==============================================
-- FIXED ACADEMIC MANAGEMENT SYSTEM MIGRATION
-- This version uses INTEGER IDs to match existing schema
...
-- ==============================================
-- 1. ROOM MANAGEMENT (Using INTEGER IDs)
-- ==============================================
...
-- ==============================================
-- 2. STUDENT GROUPS/CLASSES (Using INTEGER IDs)
-- ==============================================
...
-- ==============================================
-- 3. STUDENT REGISTRATION (Using INTEGER IDs)
-- ==============================================
...
CREATE TABLE IF NOT EXISTS student_semester_registrations (
  ...
  semester_id INTEGER REFERENCES semesters(id) ON DELETE CASCADE,
  study_year_id INTEGER REFERENCES study_years(id) ON DELETE CASCADE,
  department_id INTEGER REFERENCES departments(id) ON DELETE CASCADE,
...
-- ==============================================
-- 4. TIME SLOTS (Using INTEGER IDs)
-- ==============================================
...
-- ==============================================
-- 5. ENHANCED TIMETABLE (Using INTEGER IDs)
-- ==============================================
...
-- ==============================================
-- 6. STUDENT ACADEMIC PROGRESSION (Using INTEGER IDs)
-- ==============================================

CREATE TABLE IF NOT EXISTS student_academic_progress (
  id SERIAL PRIMARY KEY,
  student_id INTEGER REFERENCES students(id) ON DELETE CASCADE,
  department_id INTEGER REFERENCES departments(id) ON DELETE CASCADE,
  current_semester INTEGER NOT NULL,
  current_study_year_id INTEGER REFERENCES study_years(id) ON DELETE CASCADE,
...
DROP POLICY IF EXISTS "Allow all operations for authenticated users" ON student_groups;
DROP POLICY IF EXISTS "Allow all operations for authenticated users" ON student_semester_registrations;
DROP POLICY IF EXISTS "Allow all operations for authenticated users" ON time_slots;
DROP POLICY IF EXISTS "Allow all operations for authenticated users" ON timetable_entries;
DROP POLICY IF EXISTS "Allow all operations for authenticated users" ON student_academic_progress;
...
BEGIN
    RAISE NOTICE '==============================================';
    RAISE NOTICE 'FIXED ACADEMIC MANAGEMENT SYSTEM MIGRATION COMPLETE!';
    RAISE NOTICE '==============================================';
    RAISE NOTICE 'Tables created with INTEGER IDs: rooms, student_groups, student_semester_registrations,';
    ...
    RAISE NOTICE 'Foreign key constraints: Now compatible with existing schema';
