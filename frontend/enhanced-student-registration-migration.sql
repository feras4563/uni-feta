...
-- ==============================================
-- 8. INSERT SAMPLE CURRICULUM DATA
-- ==============================================

-- Sample curriculum for management department
-- You'll need to replace these with actual IDs from your database

-- Example: Create curriculum entries for existing subjects
-- INSERT INTO department_curriculum (department_id, semester_id, subject_id, semester_number, is_required)
-- SELECT 
--   'DEPT_MANAGEMENT' as department_id,
--   (SELECT id FROM semesters LIMIT 1) as semester_id,
--   s.id as subject_id,
--   COALESCE(s.semester_number, 1) as semester_number,
--   COALESCE(s.is_required, true) as is_required
-- FROM subjects s
-- WHERE s.department_id = 'DEPT_MANAGEMENT'
-- LIMIT 10;
...
BEGIN
    ...
    RAISE NOTICE '3. Update Student Registration page';
    RAISE NOTICE '4. Test invoice generation!';
    RAISE NOTICE '==============================================';
END $$;
